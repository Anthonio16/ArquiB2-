...
siguientes preguntas considerando la Tabla \ref{tab:orgd497d0b} como el
mapa de memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL.

\begin{table}[htbp]
\caption{\label{tab:orgd497d0b}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
...
\begin{frame}[label={sec:org7092eed}]{Preguntas}
\begin{enumerate}
...
\begin{frame}[label={sec:org593a7d8}]{Código RTL}
...
\begin{frame}[label={sec:org4906fc1},fragile]{Código Assembler}
