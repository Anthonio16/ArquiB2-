...
#+author: Anthonny Almeida, Jhanavi Molina, Micaela Sagnay
...
3. ¿Cuál es el valor del bit de Carry? ¿Qué operación modifica el bit?
   ...
   - Le corresponde a LSH en la instrucción 14, esta operación desplaza todos los bits una posición
     ...
     por esta razón después de ejecutar LSH el acumulador pasa de 3 a 6, además también modifica el bit carry, en
     este caso, ningún bit salió del registro, por lo que el valor del carry es 0.
...
#+begin_src
LOAD M(940)     ; 0x300 izq -> [AC] = 5
SUB M(941)      ; 0x300 der -> [AC] = 5 - 2 = 3
STOR M(940)     ; 0x301 izq -> [940] = 3
LSH             ; 0x301 der -> [AC] = 3 * 2 = 6
STOR M(941)     ; 0x302 izq -> [941] = 6
LOAD M(940)     ; 0x302 der -> [AC] = 3
STOR M(940)     ; 0x303 izq -> [940] = 3
...
| Micaela Sagnay   | micaela.sagnay@epn.edu.ec   | Codigo RTL y Assembler, tramo dir. 0x303,    |
