...
#+email: anthonny.almeida@epn.edu.ec, micaela.sagñay@epn.edu.ec, jhanavi.molina@epn.edu.ec, damian.haro@epn.edu.ec
#+date: 2026-06-12
#+language: es
...
3. ¿Cuál es el valor del bit de Carry? ¿Qué operación modifica el bit?
   ...
   - Lo genera la instrucción \textbf{SUB M(941)} en la dirección \texttt{0x300 der}. La resta
