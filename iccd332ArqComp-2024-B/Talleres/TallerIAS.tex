...
\author{Almeida Anthonny, Sagñay Micaela, Molina Jhanavi y Haro Damian}
\date{2026-06-12}
\title{Taller — Máquina IAS / Von Neumann\\\medskip
\large ICCD332 Arquitectura de Computadores}
\hypersetup{
 pdfauthor={Almeida Anthonny, Sagñay Micaela, Molina Jhanavi y Haro Damian},
...
siguientes preguntas considerando la Tabla \ref{tab:org5f6cc6f} como el
mapa de memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL.

\begin{table}[htbp]
\caption{\label{tab:org5f6cc6f}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
...
\item Lo genera la instrucción \textbf{SUB M(941)} en la dirección \texttt{0x300 der}. La resta
se ejecuta internamente como suma en complemento a 2: \(0101 + 1110 = 10011\), cuyo
carry-out del bit más significativo es \textbf{1}. Aunque LSH también desplaza bits,
la bandera de carry aritmético queda fijada por esta operación de sustracción.
\end{itemize}
\end{enumerate}
\subsubsection{Código RTL}
\label{sec:org17caee7}
...
Nombre & Email & Rol\\
\hline
Anthonny Almeida & anthonny.almeida@epn.edu.ec & Líder\\
Micaela Sagñay & micaela.sagñay@epn.edu.ec & Colaborador\\
Jhanavi Molina & jhanavi.molina@epn.edu.ec & Colaborador\\
Damian Haro & damian.haro@epn.edu.ec & Colaborador\\
\hline
\end{tabular}
\end{center}
\section{Verificación de Entregables [100\%]}
\label{sec:orgc6d19ec}
